...
<template>
  <Teleport to="body">
    <div
      ...
      @click="props.onClose"
    >
      <div class="bg-white rounded w-full max-w-[570px] overflow-hidden relative" @click.stop>
        <button class="absolute top-3 right-3 text-white cursor-pointer" @click="props.onClose">
        ...
        <div class="w-full h-[220px] mb-2 relative">
          <img
            ...
            class="h-full aspect-square object-cover absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
          />
          <img
